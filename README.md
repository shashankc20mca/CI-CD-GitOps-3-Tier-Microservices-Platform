...
Database container
For MongoDB, I used the official MongoDB Docker image instead of creating a custom image, which is a common and reliable practice.To simplify database visibility and management during development, I also used the official Mongo Express image. Mongo Express provided a web-based interface to view and interact with the MongoDB database, which made it easier to inspect collections and verify stored data.
